...
class MainUserAdmin(UserAdmin):
    ...
    additional_fields = ['email', 'role', 'date_of_birth', 'phone', 'country', 'city', 'address', 'postal_code', 'salary', 'balance']
...
class TicketAdmin(admin.ModelAdmin):
    ...
    def buy_ticket(modeladmin, request, queryset):
        ...
        percentage = 0
        if user.is_superuser or user.role == User.CINEMA_MANAGER or user.role == User.CLUB_MANAGER:
            percentage = 10
